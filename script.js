/* =========================================================
   ...
   FINAL FIREWORK SYSTEM — BIG NEON ROCKET + NORMAL ROCKETS
========================================================= */
...
const FINAL_FIREWORK_DURATION = 120000;
...
/*
   BIG ROCKET:
   Complete sequence including ascent,
   explosion and splash must finish
   inside this time.
*/
...
/*
   Approximate splash duration.
*/

const BIG_ROCKET_SPLASH_DURATION = 2100;


/*
   After big rocket is completely gone,
   six normal rockets launch together.
*/

const INITIAL_NORMAL_ROCKET_COUNT = 6;


/*
   Random normal rockets after initial 6.
*/
...
/* =========================================================
   FINAL FIREWORK SOUND
   LOOP WHILE FINAL PAGE IS ACTIVE
========================================================= */
...
/* =========================================================
   LAUNCH SIX NORMAL ROCKETS TOGETHER
========================================================= */
...
function startFinalFireworksLoop() {
    ...
    */
    ...
    let bigRocketStarted =
        false;

    let bigRocketExploded =
        false;

    let bigRocketFinished =
        false;

    let initialSixFinished =
        false;

    let lastRandomLaunch =
        0;
    ...
    /* =====================================================
       DRAW BIG NEON PARTICLES
    ===================================================== */

    function updateBigParticles(
        now
    ) {
        ...
        */
        ...
        if (
            ...
            */
            ...
            /*
               Start random system only
               after initial rockets have
               been launched.
            */
